...
NDefines.NGraphics.CAPITAL_INDICATOR_HEIGHT = 2.0 -- from 5.8 - LOWERING AS FLAGS WERE REMOVED FOR PERFORMANCE PURPOSES
NDefines.NGraphics.CAPITAL_INDICATOR_HEIGHT_SCALE = 140.0 -- from 140.0 - NOT SURE WHAT THIS DOES EXACTLY, MAY NEED CHANGING
